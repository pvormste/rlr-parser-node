...
// class ClassIndex
//==============================================================================
var ClassIndex = function(className, index) {
...
var Replay = function(parsedReplay) {
  ...
  // Class Indices
  this.classIndices = [];
  this.getClassIndices(parsedReplay);
};
...
// Add class indices from parsed replay file
Replay.prototype.getClassIndices = function(parsedReplay) {
    parsedReplay.class_indices.forEach( (element, index, array) => {
        var classIndex = new ClassIndex(element.class, element.index);

        this.classIndices.push(classIndex);
    });
};
